...
{
    // Websocket from https://developer.mozilla.org/en-US/docs/Web/API/WebSockets_API/Writing_WebSocket_server
    public class LocalServer
    {
        ...
        public LocalServer(string ip = "127.0.0.1", int port = 80)
        {
            this.ip = ip;
            this.port = port;
        ...
        {
            server.Start();
            Console.WriteLine($"Server has started on {this.ip}:{this.port}.{Environment.NewLine}Waiting for a connection...");
