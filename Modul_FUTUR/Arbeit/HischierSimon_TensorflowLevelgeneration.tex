...
\begin{enumerate}
\item No generation (ex. super mario where everything was handplaced, drawn and animated as explained in Super Mario Bros. Level 1-1\cite{EurogamerMiyamotoInterview})
\item Content generation in the game making phase. (ex. The Elder Scrolls Oblivion used \gls{pcg} to generated most of the world before the artists curated it.\cite{PCGamerCarterInterview} An example of a widely used \gls{pcg} algorithm for game studios is SpeedTree\cite{SpeedTree}
